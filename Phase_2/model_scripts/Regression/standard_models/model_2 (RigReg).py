...
def main(target_variable):
    if target_variable == "AntisocialTrajectory":
        X_train_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_old/X_train_old_AST.csv")
        X_test_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_old/X_test_old_AST.csv")
        y_train_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_old/y_train_old_AST.csv")
        y_test_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_old/y_test_old_AST.csv")

        X_train_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_new/X_train_new_AST.csv")
        X_test_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_new/X_test_new_AST.csv")
        y_train_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_new/y_train_new_AST.csv")
        y_test_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/AST_new/y_test_new_AST.csv")

    else:
        X_train_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_old/X_train_old_SUT.csv")
        X_test_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_old/X_test_old_SUT.csv")
        y_train_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_old/y_train_old_SUT.csv")
        y_test_old = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_old/y_test_old_SUT.csv")

        X_train_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_new/X_train_new_SUT.csv")
        X_test_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_new/X_test_new_SUT.csv")
        y_train_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_new/y_train_new_SUT.csv")
        y_test_new = load_data("../../../preprocessed_data/without_resampling/with_PGS/SUT_new/y_test_new_SUT.csv")
