...
def main(target_variable, tune_final=False, cv=5, final_model_name="RandomForest", model_type="final"):
    ...
    # y_train_new_mapped, y_val_new_mapped, y_test_new_mapped = get_mapped_data(y_train, y_val, y_test)
    ...
    train_and_evaluate_updated_race_stratified(final_model, X_train, y_train.values.ravel(), X_val,
                                               y_val.values.ravel(), X_test,
                                               y_test.values.ravel(), final_model_name, tune_final, cv,
