...
def main(target_variable, race_column="Race", pgs_old="with", pgs_new="with", tune_base=False, tune_final=False):
    ...
    base_model = LogisticRegression(max_iter=6850, solver='lbfgs', random_state=42, warm_start=True, dual=False,
                                    tol=0.0007847599703514606, penalty='l2', fit_intercept=True, class_weight=None,
                                    C=1.2648552168552958, multi_class='multinomial')
...
if __name__ == "__main__":
    ...
    main(target_variable, "Race", "with", "with", tune_base=False, tune_final=False)
