...
def main(
    ...
    for race in sorted(X_train_new[race_column].unique()):
        ...
        train_and_evaluate(final_model, X_train_race, y_train_race, X_val_race, y_val_race, X_test_race, y_test_race,
                           params[final_model_name], tune_final, check_overfitting, race, model_type=final_model_type,
                           cv=cv, resampling=resampling, script_name=script_name, outcome=target_variable)
